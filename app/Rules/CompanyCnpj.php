...
class CompanyCnpj implements Rule
{
	/**
	 ...
	 *
	 * @see Criando um Validator Customizado CNPJ e CPF
	 * @link http://www.laravel.com.br/criando-um-validator-customizado-cnpj-e-cpf-laravel/
